...
namespace Drugstore.API.Migrations
{
    ...
    [Migration("20230527222003_Migration_San")]
    partial class Migration_San
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryMedicine", b =>
                {
                    ...
                    b.HasKey("CategoriesId", "MedicineId");
            ...
            modelBuilder.Entity("Drugstore.Shared.Entities.Usuario.User", b =>
                {
            ...
            modelBuilder.Entity("CategoryMedicine", b =>
                {
                    b.HasOne("Drugstore.Shared.Entities.Medicamento.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Drugstore.Shared.Entities.Medicamento.Medicine", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Drugstore.Shared.Entities.Usuario.User", null)
                        .WithMany()
